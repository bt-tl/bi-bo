...
# =========================
BOT_TOKEN = (os.getenv("BOT_TOKEN") or "7789852476:AAEc8x5_zJ0Erwti7qPnv9NM414iPI1cukU").strip()
CHANNEL_ID = int((os.getenv("CHANNEL_ID") or "-1002295233216").strip() or "0")
BOT_USERNAME = (os.getenv("BOT_USERNAME") or "bicolink_com_bot").strip().lstrip("@")
DATABASE_URL = (os.getenv("DATABASE_URL") or "postgresql://postgres:ywxJjVmXHebDlxctAUKiKlyiDAunUyAS@switchyard.proxy.rlwy.net:16769/railway").strip()

OWNER_IDS = set()
_raw_owner = (os.getenv("OWNER_IDS") or "960048629").strip()
